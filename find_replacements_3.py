...
def search_radio_browser(name):
    ...
    url = f"http://161.97.219.168/json/stations/search?name={query}&limit=10&hidebroken=true&order=clickcount&reverse=true"
    try:
        req = urllib.request.Request(url, headers={'User-Agent': 'Synapse-IA-Radio-Fixer/3.0', 'Host': 'de1.api.radio-browser.info'})

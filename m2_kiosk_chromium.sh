...
chromium-browser     --kiosk     --no-first-run     --no-sandbox     --password-store=basic     --ozone-platform-hint=auto     --autoplay-policy=no-user-gesture-required     "http://localhost:5051/monitor_m2.html"

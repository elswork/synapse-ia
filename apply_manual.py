...
# Since stations_data.js is just a JS object assignment "window.STATIONS_DATA = { ... };"
# We can regex replace the URLs for each of the names.
for name, url in manual.items():
    # Find the object with this name and replace its url
    # Example snippet: "name": "Jazz24",\n      "url": "..."
...
print("Updated all 3 files with manual replacements.")
